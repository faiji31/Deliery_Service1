          ...
          <div className="px-6 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center cursor-pointer">
                    ...
                    />
                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Customer</span>
                  </label>
                  <label className="flex items-center cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="w-4 h-4 accent-blue-600"
                    />
                    <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Rider</span>
                  </label>
                </div>
              </div>
                  ...
                  >
                    {showPassword ? (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <path d="M15.171 13.576l1.514 1.515A10.023 10.023 0 0020 10c-1.274-4.057-5.064-7-9.542-7a9.958 9.958 0 00-2.037.242l1.514 1.514a4 4 0 110 5.664zM12.53 9.97l.262 2.624a1 1 0 01-1.644.962l-.87-.872a1 1 0 111.414-1.414l.838.838z" clipRule="evenodd" fillRule="evenodd" />
                      </svg>
                    ) : (
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200 transform hover:scale-105 disabled:scale-100 mt-6"
              >
                {loading ? (
            ...
            <div className="mt-6">
              <Link
                to="/login"
                className="w-full block text-center bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-semibold py-2 px-4 rounded-lg transition-colors"
              >
                Sign In
              </Link>
            </div>
